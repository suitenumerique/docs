...
| MEDIA_BASE_URL                                  |                                                                                                                             |                                                                         |
| MONITORING_BASIC_AUTH_USERNAME                  | Username required by HTTP Basic auth to reach monitoring endpoints.                                                         |                                                                         |
| MONITORING_BASIC_AUTH_PASSWORD                  | Password required by HTTP Basic auth to reach monitoring endpoints.                                                         |                                                                         |
| PROMETHEUS_METRIC_NAMESPACE                 | Prefix added to custom Prometheus metrics (e.g., `docs`).                                                                  | docs                                                                    |
| PROMETHEUS_EXPORTER_ENABLED                  | Enable Prometheus middleware and the `/metrics/` endpoint.                                                                  | false                                                                   |
