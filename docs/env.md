...
| MEDIA_BASE_URL                                  |                                                                                                                             |                                                                         |
| MONITORING_ALLOWED_CIDR_RANGES                  | Comma-separated CIDR list allowed to access `/prometheus` and `/probes/*` endpoints (`*` allows all).                        | []                                                                      |
| MONITORING_PROMETHEUS_EXPORTER                  | Enable Prometheus middleware and the `/prometheus/` metrics endpoint.                                                       | false                                                                   |
| MONITORING_PROBING                              | Enable monitoring probe endpoints (`/probes/liveness/`, `/probes/readiness/`).                                              | false                                                                   |
