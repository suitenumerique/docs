    ...
    assert response.json() == [
        {
            ...
            "children": [
                ...
                },
                {
                    ...
                    "children": [],
                    "created_at": sibling1.created_at.isoformat().replace(
                        "+00:00", "Z"
                    ),
                    ...
                    "updated_at": sibling1.updated_at.isoformat().replace(
                        "+00:00", "Z"
                    ),
                    "user_roles": [],
                },
                {
                    ...
                    "children": [],
                    "created_at": sibling2.created_at.isoformat().replace(
                        "+00:00", "Z"
                    ),
                    ...
                    "updated_at": sibling2.updated_at.isoformat().replace(
                        "+00:00", "Z"
                    ),
                    "user_roles": [],
                },
            ...
            "children": [
                {
                    ...
                    "children": [
                        ...
                        {
                            "abilities": document_sibling.get_abilities(
                                AnonymousUser()
                            ),
                            "children": [],
