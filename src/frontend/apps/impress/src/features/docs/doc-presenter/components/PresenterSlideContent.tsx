...
export const PresenterSlideContent = ({
  ...
  // and it pollutes the accessibility tree and tab order. Strip those and take
  // the node out of the tab sequence. (Observed BlockNote behaviour, not a
  // guarantee; revisit on upgrades.)
  useEffect(() => {
